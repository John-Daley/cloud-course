...
import { IonApp, IonList, IonLabel, IonInput, IonMenu, IonItem, IonButton, IonIcon,IonMenuButton, IonButtons, IonRouterOutlet, IonHeader, IonTitle, IonToolbar, IonContent, IonRippleEffect} from '@ionic/react';
...
<IonApp>
  ...
  <IonHeader className="header-css">
        ...
        <IonButtons slot="primary" onClick={menu}>
          <IonButton>
            menu
          </IonButton>
        </IonButtons>
