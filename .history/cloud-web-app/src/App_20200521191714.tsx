...
<IonApp>
<IonMenu side="start" menuId="menuTest" type="overlay">
  <IonHeader>
    <IonToolbar color="secondary">
      <IonTitle>Start Menu</IonTitle>
    </IonToolbar>
  ...
  <IonHeader className="header-css">
        ...
        <IonButtons slot="start">
          <IonMenuButton auto-hide="false" menu="menuTest" onClick= {menuController.open()></IonMenuButton>
        </IonButtons>
