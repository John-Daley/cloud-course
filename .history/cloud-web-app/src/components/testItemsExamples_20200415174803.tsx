...
const testItemsExamples: React.FC<ContainerProps> = () => {
      ...
      <IonContent>
        ...
        <IonItem button onClick={() => { }}>
          <IonAvatar slot="start">
            <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAAAAACH5BAAAAAAALAAAAAABAAEAAAICTAEAOw==" alt=" broken data " />
          </IonAvatar>
          <IonLabel>
        ...
        <IonItem href="#">
          ...
          <IonThumbnail slot="end">
            <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAAAAACH5BAAAAAAALAAAAAABAAEAAAICTAEAOw==" alt="broekn" />
          </IonThumbnail>
        </IonItem>
...
export default testItemsExamples;